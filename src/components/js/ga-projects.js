...
class GaProjects extends React.Component {
  ...
  render() {
    return (
      <div className="ga-projects">
        <div className="container">

          <h2 className="ga-projects__title header">General Assembly Projects</h2>
          ...
          <div className="swiper-container">
            <div className="swiper-wrapper">
              ...
              <div className="swiper-slide">
                <div className="ga-projects__content-wrapper">
                  <div className="ga-projects__top-wrapper">
                    <h3 className="ga-projects__project-title">Space Invaders</h3>
                  ...
                  <div className="ga-projects__body-wrapper">
                    ...
                    <div className="ga-projects__text-wrapper">
                      <h3 className="ga-projects__subtitle">Software:</h3>
              ...
              <div className="swiper-slide">
                <div className="ga-projects__content-wrapper">
                  <div className="ga-projects__top-wrapper">
                    <h3 className="ga-projects__project-title">Comedy Night Hackathon</h3>
              ...
              <div className="swiper-slide">
                <div className="ga-projects__content-wrapper">
                  <div className="ga-projects__top-wrapper">
                    <h3 className="ga-projects__project-title">Explore Travel</h3>
              ...
              <div className="swiper-slide">
                <div className="ga-projects__content-wrapper">
                  <div className="ga-projects__top-wrapper">
                    <h3 className="ga-projects__project-title">Sunset Barlevard</h3>
